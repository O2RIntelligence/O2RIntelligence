(function($) {
    ...
    $(function() {
        ...
        window["mapRecord"] = function(seat, record, CR_Group = false) {
            ...
            record.net_revenue = record.revenue_total - record.excluded_revenue - record.marketplace_fee;
            record.gross_profit = record.revenue_total - record.excluded_revenue - record.media_cost - record.operation_fee;
